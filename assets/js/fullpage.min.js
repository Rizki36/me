...
!(function (n, t) {
  ...
  var Ti,
    ...
    Di =
      ...
      xi),
    Ei = {
      Wn: "ontouchmove" in window ? "touchmove" : Di ? Di.move : null,
      Vn: "ontouchstart" in window ? "touchstart" : Di ? Di.down : null,
    };
  function Ri(n) {
  ...
  function eo(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            hn().B && n.getBoundingClientRect().bottom >= 0 && "up" === li.In(),
          i = hn().Hn;
        if (i) return V(t), !1;
        if (hn().B) {
          if (e) {
            var o;
            if (!(i || (gi("isNewKeyframe", "beyondFullpage") && li.Bn())))
              return (
                (o = Rt(
                  rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight
            ...
            if (li.Bn())
              return (
                (e = !1), dn({ Hn: !0 }), dn({ N: "wheel" }), vi(), V(t), !1
              );
    ...
    n
      ? (to(!0),
        (function () {
          if (Ei.Wn && (a || c)) {
            bt().autoScrolling &&
              (Vt.removeEventListener(Ei.Wn, Ni, { passive: !1 }),
              Vt.addEventListener(Ei.Wn, Ni, { passive: !1 }));
            var n = bt().touchWrapper;
            n.removeEventListener(Ei.Vn, zi),
              n.removeEventListener(Ei.Wn, Ri, { passive: !1 }),
              n.addEventListener(Ei.Vn, zi),
              n.addEventListener(Ei.Wn, Ri, { passive: !1 });
          }
        })())
      : (to(!1),
        (function () {
          if (Ei.Wn && (a || c)) {
            bt().autoScrolling &&
              (Vt.removeEventListener(Ei.Wn, Ri, { passive: !1 }),
              Vt.removeEventListener(Ei.Wn, Ni, { passive: !1 }));
            var n = bt().touchWrapper;
            n.removeEventListener(Ei.Vn, zi),
              n.removeEventListener(Ei.Wn, Ri, { passive: !1 });
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = F(i, n);
                (t || o) &&
                  (f.shared.Kn || ro(!1), (f.shared.Kn = !0), (e = !0));
              }
            }),
          !e && f.shared.Kn && (ro(!0), (f.shared.Kn = !1))))
      : ro(!0);
  }
  function fo(n, t) {
  ...
  (f.reBuild = bo),
    ...
    sn.L(yn, function () {
      _("wheel", li.Nn, oi()), sn.L(Ln, fi), sn.L(xn, si);
    }),
    sn.L(yn, function () {
      sn.L(gn, Ao);
    }),
  ...
  function Do(n) {
    ...
    if (
      ...
      hn().F &&
      (rn(hn().C),
      !hn().B && !hn().Hn && (!bt().autoScrolling || bt().scrollBar))
    ) {
      var a = H(),
        u = (function (n) {
          var t = n > Lo ? "down" : "up";
  ...
  function No() {
    ...
    "" === bt().licenseKey.trim()
      ...
      : (bt() && vn.Yn) || r.domain.indexOf("alvarotrigo.com") > -1
      ? n && n.length
      : (v(
          "error",
  ...
  function Bo(n, t) {
    ...
    if (
      ...
      return (
        ...
        (f.shared = Object.assign(f.shared, { $n: null, Kn: !1 })),
        (o.fullpage_api = f),
      ...
      sn.L(bn, function () {
        ...
        dn({
          Yn:
            ...
            ((u || c) &&
              ((bt().credits && u && e <= u.Qn && u.Jn === t.split(n[0])[4]) ||
                c ||
                u.Xn)) ||
              !1),
        });
